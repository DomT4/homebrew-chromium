class Chromium < Formula
  ...
  url "https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/Mac%2F606622%2Fchrome-mac.zip?generation=1541721617429540&alt=media", :using => :nounzip
  version "c606622"
