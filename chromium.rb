class Chromium < Formula
  ...
  url "https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/Mac%2F721688%2Fchrome-mac.zip?generation=1575499076586068&alt=media", :using => :nounzip
  version "c721688"
