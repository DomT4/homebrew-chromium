class Chromium < Formula
  ...
  url "https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/Mac%2F730425%2Fchrome-mac.zip?generation=1578754511276074&alt=media", :using => :nounzip
  version "c730425"
